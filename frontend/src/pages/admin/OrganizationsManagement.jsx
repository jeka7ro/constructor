...
export default function OrganizationsManagement() {
    ...
    const [adminFormData, setAdminFormData] = useState({ email: '', full_name: '', old_password: '', password: '', confirm_password: '', role: 'ADMIN' })
    ...
    const handleUpdatePassword = async (e) => {
        ...
        try {
            await api.put(`/admin/organizations/${adminsDrawerOrg.id}/admins/${editingAdminId}/password`, {
                old_password: adminFormData.old_password,
                password: adminFormData.password
            })
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-md shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <form onSubmit={handleUpdatePassword}>
                            <div className="p-6 space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-600 dark:text-slate-400 mb-1.5">Parola Veche *</label>
                                    <div className="relative">
                                        <input required type={showPassword ? 'text' : 'password'} value={adminFormData.old_password} onChange={e => setAdminFormData({...adminFormData, old_password: e.target.value})} className="w-full pl-4 pr-12 h-10 text-sm rounded-full border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 bg-white dark:bg-slate-900 dark:text-white outline-none transition-all shadow-sm" placeholder="Parola curentă a contului" />
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
