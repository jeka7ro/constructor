            ...
            <div className="flex items-center gap-3 shrink-0">
                {isMandatory !== undefined && onMandatoryChange !== null && (
                    <label className="flex items-center gap-1.5 cursor-pointer">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">{t("pricing_settings.mandatory", "Obligatoriu")}</span>
                    </label>
                )}
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div className="flex flex-wrap border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950">
                ...
                >
                    ...
                    {t('pricing_settings.tab_chape', 'Chape')}
                </button>
                <button
            ...
            <div className="px-5 pt-1 pb-4">
                    ...
                    <>
                        ...
                        <div className="mt-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                            <div className="px-4 py-2 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                                ...
                                <button onClick={onAddThreshold} className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-full border border-slate-300 dark:border-slate-600 shadow-sm hover:bg-slate-50 transition-colors">
                            ...
                            <div className="p-3">
                                {(settings.surface_thresholds || []).map(row => (
                                    <div key={row.id} className="grid grid-cols-4 gap-2 py-1 items-center border-b border-slate-200 dark:border-slate-700 last:border-0">
                                        ...
                                        <button onClick={() => onRemoveThreshold(row.id)} className="p-1.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-full justify-self-end transition-colors"><Trash2 className="w-4 h-4" /></button>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden mb-4">
                            <div className="px-4 py-2 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                                ...
                                <button onClick={addEpsRow} className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-full border border-slate-300 dark:border-slate-600 shadow-sm hover:bg-slate-50 transition-colors">
                                    <Plus className="w-3 h-3" /> {t("common.add", "Ajouter")}
                                </button>
                            </div>
                            <div className="p-3">
                                ...
                                {(settings.eps_volume_thresholds || []).map((row, idx) => (
                                    <div key={idx} className="grid grid-cols-4 gap-2 py-1 items-center">
                                        ...
                                        <button onClick={() => removeEpsRow(idx)} className="p-1.5 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-full justify-self-end transition-colors"><Trash2 className="w-4 h-4" /></button>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {activeTab === 'logistics' && (
                    <>
                        ...
                        <SectionHeader label={t('pricing_settings.section_transport_pur', 'Transport PUR')} />
                        ...
                        <SectionHeader label={t('pricing_settings.section_transport_eps', 'Transport EPS')} />
