...
def apply_migration():
    with engine.connect() as conn:
        ...
        # Add country column
        try:
            conn.execute(text("ALTER TABLE organizations ADD COLUMN country VARCHAR(50) DEFAULT 'BE';"))
        ...
        try:
            conn.execute(text("ALTER TABLE organizations ADD COLUMN default_language VARCHAR(10) DEFAULT 'ro';"))
